...
1. GET api/fleet_analytics/alert_summary/:fleet_id
    ...
    - Return a fleet-level alert summary, with the number of alerts raised for an alert_type and severity
...
3. GET api/fleet_analytics/total_distance_travelled_in_last_24_hours/:fleet_id
